      ...
      <Router>
        <div className="container-fluid">
          <ul class="nav nav-tabs">
            <li class="nav-item">
              <Link onClick={this.toggleBox2} className={`nav-link ${this.state.isActive ? "":"active"}`} to="/hospitals">
                Hospitals & beds
              </Link>
            </li>
            <li class="nav-item">
              <Link onClick={this.toggleBox1} className={`nav-link ${!this.state.isActive ? "":"active"}`} to="/hospitals/medicalclgbeds">
